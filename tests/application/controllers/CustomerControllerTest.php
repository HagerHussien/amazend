...
class CustomerControllerTest extends Zend_Test_PHPUnit_ControllerTestCase
{
    ...
    {
        $params = array('action' => 'login', 'controller' => 'Customer', 'module' => 'default');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
    ...
    {
        $params = array('action' => 'add', 'controller' => 'Customer', 'module' => 'default');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
    ...
    {
        $params = array('action' => 'myWishList', 'controller' => 'Customer', 'module' => 'default');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
    ...
    {
        $params = array('action' => 'addcart', 'controller' => 'Customer', 'module' => 'default');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
    ...
    {
        $params = array('action' => 'logout', 'controller' => 'Customer', 'module' => 'default');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
    ...
    {
        $params = array('action' => 'addrate', 'controller' => 'Customer', 'module' => 'default');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
